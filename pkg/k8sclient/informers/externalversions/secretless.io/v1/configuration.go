...
import (
	...
	versioned "github.com/cyberark/secretless-broker/pkg/k8sclient/clientset/versioned"
	internalinterfaces "github.com/cyberark/secretless-broker/pkg/k8sclient/informers/externalversions/internalinterfaces"
	v1 "github.com/cyberark/secretless-broker/pkg/k8sclient/listers/secretless.io/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.SecretlessV1().Configurations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SecretlessV1().Configurations(namespace).Watch(context.TODO(), options)
			},
		},
		&secretlessiov1.Configuration{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *configurationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&secretlessiov1.Configuration{}, f.defaultInformer)
}
