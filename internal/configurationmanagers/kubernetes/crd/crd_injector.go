...
func createCRD(apiExtClient *apiextensionsclientset.Clientset) error {
	secretlessCRD := &apiextensionsv1.CustomResourceDefinition{
	...
	res, err := apiExtClient.ApiextensionsV1().CustomResourceDefinitions().Create(context.TODO(), secretlessCRD, meta_v1.CreateOptions{})
